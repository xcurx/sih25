...
export default function InterviewsPage() {
    ...
    return (
        <div className="relative p-6 max-w-7xl w-full mx-auto space-y-8">
            ...
            {/* OLD GLOBAL BACKGROUND DIV REMOVED */}
            {/* <div
...
<section className="relative overflow-hidden rounded-[32px] border border-sky-100 bg-gradient-to-br from-white via-sky-50 to-blue-50 p-8 shadow">
    ...
    {/* RADIAL GRADIENT DIV */}
    {/* I've kept the 55% fade-out from your last snippet */}
    <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(14,165,233,0.08),transparent_55%)]" />
    
    {/* LAYOUT CHANGE: Removed lg:flex-row and lg:justify-between to force stacking. 
       Adjusted spacing to space-y-6. This ensures cards are below the title. */}
    <div className="relative flex flex-col space-y-6"> 
        ...
        {/* Stats Cards (Now stacked vertically below the title) */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full">
            
            {/* CARD 1: hover:border-sky-200 REMOVED */}
            <Card className="border-slate-200 bg-white shadow-lg hover:shadow-xl">
            ...
            {/* CARD 2: hover:border-sky-200 REMOVED */}
            <Card className="border-slate-200 bg-white shadow-lg hover:shadow-xl">
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            {/* CARD 3: hover:border-sky-200 REMOVED */}
            <Card className="border-slate-200 bg-white shadow-lg hover:shadow-xl">
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            {/* CARD 4: hover:border-sky-200 REMOVED */}
            <Card className="border-slate-200 bg-white shadow-lg hover:shadow-xl">
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
