...
export default function PostJobsPage() {
  ...
  if (user?.role !== "employer" && user?.role !== "placement_cell") {
    return (
      <div className="p-6">
        <div className="text-center py-12">
          <h1 className="text-2xl font-bold text-destructive">Access Denied</h1>
          <p className="text-muted-foreground">This page is only accessible to employers and placement cell.</p>
        </div>
      </div>
    )
  }
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="salaryMax">Maximum Salary/Stipend (₹) *</Label>
                <Input
                  id="salaryMax"
                  type="number"
                  placeholder="35000"
