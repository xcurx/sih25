...
import { Button } from "@/components/ui/button"
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card"
import { ArrowUpRight, Briefcase, Calendar, CheckCircle, FileText, MapPin } from "lucide-react"
import { useEffect, useMemo, useState } from "react"
import { Opportunity, Student } from "@/lib/types"
import axios from "axios"
import Loader from "../loader/Loader"
...
const SCHEDULER_URL =
  "https://script.google.com/macros/s/AKfycbzw8spoYNKjlqXB2fYkYAixzMaFaCrphSVOq9YKm8ycbb2Fq2O8g0nAsKaE7_T82I75cA/exec"
          ...
          <div className="space-y-4">
            <div>
              ...
              <h1 className="mt-3 text-3xl font-semibold text-slate-900">
                Monitor opportunity performance and act fast.
              </h1>
              <p className="mt-2 text-sm text-slate-600">
                Every posting, candidate count, and next action is summarised right here.
              </p>
            ...
            {students.slice(0, 4).map((student, index) => (
              ...
              >
                ...
                <div className="flex gap-2">
                  ...
                  {/* 🔹 Opens Apps Script in a popup window */}
                  <Button
                    size="sm"
